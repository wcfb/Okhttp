...
public class OkManager {
     ...
     * @param callBack
     */
    public void asyncJsonStringByURL(String url, final Func callBack){
        Request request = new Request.Builder().url(url).build();
     ...
     * @param callBack
     */
    public void onSuccessJsonStringMethod(final String jsonValue, final Func callBack){
     ...
     * @param callBack
     */
    public void sendComplexForm(String url, Map<String, String> params,
                                final Func4 callBack){
    ...
    public void sendStringByPostMethod(String url,String content,final Func4 callBack){
        Request request = new Request.Builder().url(url)
                .post(RequestBody.create(MEDIA_TYPE_MARKDOWN,content)).build();
        client.newCall(request).enqueue(new Callback() {
            @Override
            public void onFailure(Call call, IOException e) {
                e.printStackTrace();
